function mapStimArray(varargin)
...
method = 'nearest'; % 'natural', 'Linear', 'nearest', or 'cubic'
...
if numArgs >= 3 && ~isempty(varargin{3})
    ax = varargin{3};
end

if numArgs == 4
    goodChans = varargin{4};
    x = x(goodChans);
    y = y(goodChans);
end
...
hold on; scatter(x,y,10,'k','filled');
